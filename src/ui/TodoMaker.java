 ...
 * @author sheldon
 */
public class TodoMaker extends javax.swing.JInternalFrame {
DataConnect dc = new DataConnect();
Todo td = new Todo();
    /**
     * Creates new form TodoMaker
     */
    public TodoMaker() {
        initComponents();
        populateTodo();
    ...
    public void progress(){
        ...
        taskCmpltLabel.setText(String.valueOf(tasksDone));
    }
    ...
    private void initComponents() {
        ...
        taskCmpltLabel = new javax.swing.JLabel();
        ...
        todoTitleLabel.setText("Agility TODO");
        taskPanel.add(todoTitleLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 0, -1, -1));

        jLabel1.setText("Tasks Completed:");
        taskPanel.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 90, -1, -1));

        jLabel2.setText("Tasks Created:");
        taskPanel.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 120, -1, -1));
        ...
        taskCmpltLabel.setText("No tasks created, create one below!");
        taskPanel.add(taskCmpltLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 90, -1, -1));
    ...
    private void removeTaskButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_removeTaskButtonActionPerformed
        dc.deleteToDo(todoTextField.getText());
        refresh();
    ...
    private javax.swing.JLabel taskCmpltLabel;
